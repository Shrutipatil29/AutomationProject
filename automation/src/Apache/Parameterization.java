...
public class Parameterization {
    public static String getExcelData(int row, int cell) throws EncryptedDocumentException, IOException {
        FileInputStream file = new FileInputStream("/Users/ac02d77qnmd6m/Documents/Test_data.xlsx");
    ...
    public static double getData(int rows, int cells) throws IOException {
                FileInputStream files = new FileInputStream("/Users/ac02d77qnmd6m/Documents/Test_data.xlsx");
